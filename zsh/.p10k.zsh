# Generated by Powerlevel10k configuration wizard on 2025-07-18 at 16:11 JST.
...
# round separators, round heads, round tails, 2 lines, dotted, right frame,
...
() {
  ...
  # Use explicit bright color to ensure readability on blue background in both Ghostty and cmux
